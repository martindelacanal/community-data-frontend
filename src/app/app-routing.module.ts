...
const routes: Routes = [
  ...
  { path: 'view/worker/:id', component: ViewWorkerComponent, canActivate: [RoleGuard], data: {expectedRoles: ['admin', 'opsmanager']} },
  ...
  { path: 'table/worker', component: TableWorkerComponent, canActivate: [RoleGuard], data: {expectedRoles: ['admin', 'opsmanager']} },
