...
const routes: Routes = [
  ...
  { path: 'view/ticket/:id', component: ViewTicketComponent, canActivate: [RoleGuard], data: {expectedRoles: ['admin', 'client', 'opsmanager', 'director', 'stocker']} },
  ...
  { path: 'edit/ticket/:id', component: StockerHomeComponent, canActivate: [RoleGuard], data: {expectedRoles: ['admin', 'stocker' ]} },
  ...
  { path: 'table/ticket', component: TableTicketComponent, canActivate: [RoleGuard], data: {expectedRoles: ['admin', 'opsmanager', 'director', 'stocker']} },
  ...
  { path: 'settings', component: SettingsComponent, canActivate: [RoleGuard], data: {expectedRoles: ['admin', 'client', 'stocker', 'delivery', 'beneficiary', 'opsmanager', 'director']} },
  { path: 'help', component: HelpComponent, canActivate: [RoleGuard], data: {expectedRoles: ['admin', 'client', 'stocker', 'delivery', 'beneficiary', 'opsmanager', 'director']} },
