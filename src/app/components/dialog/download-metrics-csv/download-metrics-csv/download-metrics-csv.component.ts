...
@Component({
  selector: 'app-download-metrics-csv',
  templateUrl: './download-metrics-csv.component.html',
  styleUrls: ['./download-metrics-csv.component.scss']
})
export class DownloadMetricsCsvComponent {

  dateForm: FormGroup;

  constructor(
    public dialogRef: MatDialogRef<DownloadMetricsCsvComponent>,
